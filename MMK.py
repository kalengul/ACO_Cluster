...
while Par<=endParametr:
    ...
    while NomStatIteration<KolStatIteration:
        ...
        print(datetime.now(),' END ',(datetime.now() - StartTime)*(KolStatIteration-NomStatIteration),' typeParametr=',typeParametr,Par,' NomStatIteration ',NomStatIteration,"{:8.3f}".format(Stat.MIterationAntZero/NomStatIteration),' Duration: {} '.format(datetime.now() - StartTime),' OptimPath ',OptimPath,version)
